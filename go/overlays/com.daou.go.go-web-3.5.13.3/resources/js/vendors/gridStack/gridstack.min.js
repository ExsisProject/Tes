...
(function(factory) {
  ...
  GridStack.prototype.getAll = function () {
    return this.engine.nodes;
  }

  GridStack.prototype.getByRid = function (rid) {
    return this.engine.nodes.find(function(node) { return rid === node.rid });
  }

  GridStack.prototype.removeNode = function (rid) {
    this.engine.removeNode(this.getByRid(rid));
  }
