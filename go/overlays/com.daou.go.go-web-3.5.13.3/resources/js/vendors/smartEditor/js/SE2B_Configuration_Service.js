...
window.goContext = document.getElementsByTagName('meta')[0].getAttribute('content');
/**
...
nhn.husky.SE2M_Configuration.SE2B_CSSLoader = {
	sCSSBaseURI : window.goContext + "resources/js/vendors/smartEditor/css"
};
...
nhn.husky.SE2M_Configuration.SE_EditingAreaManager = {
	sCSSBaseURI : "css",
	sBlankPageURL : window.goContext + "resources/js/vendors/smartEditor/smart_editor2_inputarea.html",
	sBlankPageURL_EmulateIE7 : window.goContext + "resources/js/vendors/smartEditor/smart_editor2_inputarea_ie8.html",
