...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	 ...
	 * 포토 웹탑 오픈
	 */
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(e){			

		//var jindoEl = jindo.$Element(e.element);
		//if(jindoEl.hasClass('notMail')){
		// go customize 
		parent.inlineImgUploadLayer(this.oApp.elPlaceHolder.id);
		return;
		/*}else{
			this.htPopupOption.sUrl = this.makePopupURL();
			this.htPopupOption.sProperties = "left=0,top=0,width=360,height=230,scrollbars=no,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "/mail/editor/se2/photo_uploader/popup/photo_uploader.jsp?locale="+tmsLocale;
