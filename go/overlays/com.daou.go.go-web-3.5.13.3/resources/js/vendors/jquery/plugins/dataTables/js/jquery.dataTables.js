...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnAjaxUpdateDraw ( oSettings, json )
		{
			...
			/** go custom **/
			if(oSettings.sAjaxRecordTotalProp) 
			{	
				oSettings._iRecordsTotal = _fnGetObjectDataFn( oSettings.sAjaxRecordTotalProp )( json );
				
			} 
			if(oSettings.sAjaxRecordDisplayProp) 
			{	
				oSettings._iRecordsDisplay = _fnGetObjectDataFn( oSettings.sAjaxRecordDisplayProp )( json );
			}
		...
		return this.each(function() {
			...
			_fnMap( oSettings, oInit, "sAjaxRecordTotalProp" );
			_fnMap( oSettings, oInit, "sAjaxRecordDisplayProp" );
	...
	DataTable.defaults = {
		...
		/** go custom **/
		"sAjaxRecordTotalProp" : "iTotalRecords",
	    "sAjaxRecordDisplayProp" : "iTotalDisplayRecords",
	...
	DataTable.models.oSettings = {
		...
		/** go custom **/
		"sAjaxRecordTotalProp": null,
		"sAjaxRecordDisplayProp": null,
