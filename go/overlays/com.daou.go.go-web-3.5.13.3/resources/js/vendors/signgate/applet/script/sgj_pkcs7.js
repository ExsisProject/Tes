...
function SGJ_addSignPKCS7DataWithAlgo(strUserID, data, algorithm)
{
	...
	if ( isNull(strUserID) || isNull(data) || isNull(algorithm))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_addSignPKCS7DataWithAlgo()" );
		return "";
	}
	
	var strPKCS7Message = SG.addSignPKCS7Data(strUserID, data, algorithm);
...
function SGJ_genPKCS7SignedDataWithAlgo(strUserID, data, algorithm )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7SignedDataWithAlgo()" );
		return "";
	}
...
function SGJ_genPKCS7SignedFileWithAlgo( strUserID, strInputFilePath, strOutputFilePath, algorithm, fileType)
{
	...
	if ( isNull(strUserID) ||isNull(strInputFilePath) 
			|| isNull(strOutputFilePath) || isNull(algorithm) || isNull(fileType))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7SignedFileWithAlgo()" );
		return false ;
	}
...
function SGJ_addSignPKCS7Data( strUserID, strP7Msg )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_addSignPKCS7Data()" );
		return "";
	}
...
function SGJ_addSignPKCS7File( strUserID, strP7FilePath, strOutputFilePath)
{
	...
	if ( isNull(strUserID) || isNull(strP7FilePath) || isNull(strOutputFilePath))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_addSignPKCS7File()" );
		return false;
	}

	var bReturn = SG.addSignPKCS7File( strUserID, strP7FilePath, strOutputFilePath );
	if( !bReturn )
	{
		setErrorCode( "INVALID_RETURN_VALUE" );
		setErrorMsg(SGJ_getErrorMsg());
...
function SGJ_genPKCS7EnvelopedDataWithAlgo( strUserID, kmCert, data, algorithm )
{
	...
	if ( isNull(strUserID) || isNull(kmCert) || isNull(data) || isNull(algorithm))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7EnvelopedDataWithAlgo()" );
		return "" ;
	}
...
function SGJ_genPKCS7EnvelopedFileWithAlgo( strUserID, kmCert, strInputFilePath, strOutputFilePath, algorithm, fileType )
{
	...
	if ( isNull(strUserID) || isNull(kmCert) || isNull(strInputFilePath) || 
			isNull(strOutputFilePath) || isNull(algorithm) || isNull(fileType))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7EnvelopedFileWithAlgo()" );
		return false;
	}
...
function SGJ_genMultiPKCS7EnvelopedDataWithAlgo(strUserID, kmCert, data, algorithm)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genMultiPKCS7EnvelopedDataWithAlgo()" );
		return "" ;
	}

	var strPKCS7Message = SG.genMultiPKCS7EnvelopedData(strUserID, kmCert, data, algorithm);
	if( isNull(strPKCS7Message))
	{
		setErrorCode( "INVALID_RETURN_VALUE" );
		setErrorMsg(SGJ_getErrorMsg());
...
function SGJ_genMultiPKCS7EnvelopedFileWithAlgo(strUserID, kmCert, strInputFilePath, strOutputFilePath, algorithm, fileType)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genMultiPKCS7EnvelopedFileWithAlgo()" );
		return false;
	}

	var bReturn = SG.genMultiPKCS7EnvelopedFile( strUserID, kmCert, strInputFilePath, strOutputFilePath, algorithm, fileType );
	if( !bReturn )
	{
		setErrorCode( "INVALID_RETURN_VALUE" );
		setErrorMsg(SGJ_getErrorMsg());
...
function SGJ_genPKCS7SignEnvDataWithAlgo( strUserID, kmCert, data, encAlgorithm, signAlgorithm )
{
	...
	if ( isNull(strUserID) || isNull(kmCert) || isNull(data) || isNull(encAlgorithm))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7SignEnvDataWithAlgo()" );
		return "" ;
	}
...
function SGJ_genPKCS7SignEnvFileWithAlgo( strUserID, kmCert, strInputFilePath, strOutputFilePath, encAlgorithm, signAlgorithm, fileType )
{
	...
	if ( isNull(strUserID) || isNull(kmCert) || isNull(strInputFilePath) 
			|| isNull(strOutputFilePath) || isNull(encAlgorithm) || isNull(fileType))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genPKCS7SignEnvFileWithAlgo()" );
		return false;
	}
...
function SGJ_genMultiPKCS7SignEnvDataWithAlgo ( strUserID, kmCert, data, encAlgorithm, signAlgorithm )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genMultiPKCS7SignEnvDataWithAlgo()" );
		return "" ;
	}

	var strPKCS7Message = SG.genMultiPKCS7SignEnvData( strUserID, kmCert, data, encAlgorithm, signAlgorithm );
	if( isNull(strPKCS7Message))
	{
		setErrorCode( "INVALID_RETURN_VALUE" );
		setErrorMsg(SGJ_getErrorMsg());
...
function SGJ_genMultiPKCS7SignEnvFileWithAlgo( strUserID, kmCert, strInputFilePath, strOutputFilePath, encAlgorithm, signAlgorithm, fileType)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_genMultiPKCS7SignEnvFileWithAlgo()" );
		return false;
	}

	bReturn =  SG.genMultiPKCS7SignEnvFile( strUserID, kmCert, strInputFilePath, strOutputFilePath, encAlgorithm, signAlgorithm, fileType );
	if( !bReturn )
	{
		setErrorCode( "INVALID_RETURN_VALUE" );
		setErrorMsg(SGJ_getErrorMsg());
...
function SGJ_verifyPKCS7Data( strUserID, strP7Msg )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7Data()" );
		return "";
	}
...
function SGJ_verifyPKCS7SignedData( strP7Msg )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7SignedData()" );
		return "";
	}
...
function SGJ_verifyPKCS7EnvelopedData( strUserID, strP7Msg )
{
	...
	if( isNull(strUserID) || isNull(strP7Msg) )
	{
		...
		setErrorFunction( "SGJ_verifyPKCS7EnvelopedData()" );
		return "";
	}
...
function SGJ_verifyPKCS7SignEnvData( strUserID, strP7Msg )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7SignEnvData()" );
		return "";
	}
...
function SGJ_verifyPKCS7File(strUserID, p7File, orgFile)
{
	...
	if( isNull(strUserID) || isNull(p7File) || isNull(orgFile) )
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7File()" );
		return false;
	}
...
function SGJ_verifyPKCS7SignedFile( p7File, orgFile )
{
	...
	if( isNull(p7File) || isNull(orgFile) )
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7SignedFile()" );
		return false;
	}
...
function SGJ_verifyPKCS7EnvelopedFile( strUserID, p7File, orgFile )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7EnvelopedFile()" );
		return false;
	}
...
function SGJ_verifyPKCS7SignEnvFile(strUserID, p7File, orgFile)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_verifyPKCS7SignEnvFile()" );
		return false;
	}
...
function SGJ_getPKCS7Type( strP7Msg )
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getPKCS7Type()" );
		return "" ;
	}
...
function SGJ_getPKCS7TypeFile( strP7FilePath)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getPKCS7TypeFile()" );
		return "" ;
	}
...
function SGJ_getSigningTime(p7Data, index)
{
	...
	var strCert = SG.getSigningTime(p7Data, index);
...
function SGJ_getSignerCertwithDN(p7Data, subjectDN)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSignerCertwithDN()" );
		return "" ;
	}
...
function SGJ_getSigningTimeWithDN(p7Data, subjectDN)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSigningTimeWithDN()" );
		return "" ;
	}

	var strCert = SG.getSigningTime(p7Data, subjectDN);
...
function SGJ_getSignerCount(p7Data)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSignerCount()" );
		return 0;
	}
...
function SGJ_getSigningTimeFile(p7File, index)
{
	...
	var strCert = SG.getSigningTimeFile(p7File, index);
...
function SGJ_getSignerCertFileWithDN(p7File, subjectDN)
{
	...
	if( isNull(p7File) || isNull(subjectDN))
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSignerCertFileWithDN()" );
		return "" ;
	}
...
function SGJ_getSigningTimeFileWithDN(p7File, subjectDN)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSigningTimeFileWithDN()" );
		return "" ;
	}

	var strCert = SG.getSigningTimeFile(p7File, subjectDN);
...
function SGJ_getSignerCountFile(p7File)
{
	...
	{
		setErrorCode( "PARAMETER_NULL" );
		setErrorFunction( "SGJ_getSignerCountFile()" );
		return 0;
	}
