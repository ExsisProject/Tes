require.config({
    ...
    paths: {
        ...
        "gridstack.grid-jquery-ui": "../vendors/gridStack/gridstack.jQueryUI.min",
        "gridstack.jquery-ui": "../vendors/gridStack/jquery-ui.min",
        "gridstack": "../vendors/gridStack/gridstack.min",
        "jquery.ganttView": "../vendors/jquery/plugins/ganttView/jquery.ganttView.custom", //Works에서 사용
        "jquery.ganttView.date": "../vendors/jquery/plugins/ganttView/date", //Works에서 사용
...
//            "backbone.touch": "../vendors/backbone/plugins/backbone.touch",
        ...
        "mxgraph.mxClient": "../vendors/mxgraph/mxClient",

        "html2canvas": "../vendors/html2Canvas/html2canvas.min",
        "jspdf": "../vendors/jsPdf/jspdf.umd.min",
        ...
        "jquery.works-calbean": "../libs/calbean/works-calbean",
        ...
        "kakao": "//dapi.kakao.com/v2/maps/sdk.js?appkey=3a6bd28fe2d524c5415fd592daac2758&libraries=services&autoload=false"
    },
    ...
    shim: {
        ...
        "jquery.ganttView": {
            deps: ["jquery", "jquery.ui", "jquery.ganttView.date"]
        },
        "jquery.flot": {
            deps: ["jquery"],
            init: function () {
