;(function () {
    define([
        ...
        function (
            ...
            var TodoViewerList = PaginatedCollection.extend({
                ...
                url: function () {
                    return '/api/approval/todoviewer/all';
                }
            });


            var TodoViewerListView = MoreView.extend({
                    el: '#content',
                    initialize: function (options) {
                        ...
                        this.collection = new TodoViewerList();
