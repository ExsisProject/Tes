define([
    ...
    "underscore",
    "backbone",
    "hgn!approval/templates/mobile/document/m_docinfo",
    "hgn!approval/templates/mobile/document/m_docinfo_view",
...
function(
    ...
    var DocInfoView = Backbone.View.extend({
        ...
        makeDocInfo: function(docInfoTpl){
        ...
        docYearSelect: function(e){
        	this.docInfoModel['docYear'] = $(e.currentTarget).find('options:selected').val();
