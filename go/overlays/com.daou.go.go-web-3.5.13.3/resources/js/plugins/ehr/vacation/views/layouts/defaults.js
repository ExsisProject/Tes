(function() {
    ...
    function(
        ...
        var __super__ = DefaultLayout.prototype, 
            ...
            VacationDefaultLayout;

        var instance = null;

        VacationDefaultLayout = DefaultLayout.extend({
            className: 'go_new go_skin_default go_skin_ehr',
            contentTopView: null,
            sideView : null,
            initialize: function() {
            ...
            initPopupMarkup: function() {
                $("body").append("<div class='go_content go_renew annualvacation'><div id='content'></div></div>");
            },
