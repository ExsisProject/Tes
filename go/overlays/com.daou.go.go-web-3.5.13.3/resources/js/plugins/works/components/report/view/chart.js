    ...
    return Backbone.View.extend({
        ...
        _getChartTitle: function () {
            ...
            if (this.model.get('combination') && (this.chartDatas.length != this.subChartDatas.length)) {
                var aggField;
                if (this.chartDatas.length > this.subChartDatas.length) {
                    aggField = this.subChartDatas.aggField;
                } else {
                    aggField = this.chartDatas.aggField;
                }

                var targetField = aggField? aggField.get('label') : '';
