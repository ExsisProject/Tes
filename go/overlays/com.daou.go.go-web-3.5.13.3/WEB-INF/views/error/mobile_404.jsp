...
.btn_major span.txt {font-size: 16px;color: #fff;font-weight: bold;letter-spacing: 0;text-shadow: 0 -1px 0 #666;display:inline-block;vertical-align:top; padding-top:8px}
			...
			<div class="content_page">
				<div class="content">
					<div class="notice" style="margin-top:0">
						...
						<h2 class="title"><%= messageSourceHelper.getMessage("error.404.title") %></h2>
						<span class="desc"><%= messageSourceHelper.getMessage("common.page.invalid.address") %></span>
						<br />
						<a class="btn_major_s" onclick="javascript:history.go(-1);" style="cursor: pointer;"><span class="btn_major" data-role="button"><span class="txt"><%= messageSourceHelper.getMessage("common.page.back") %></span></span></a>							
					</div>
				</div>
			</div>			
		</div>
