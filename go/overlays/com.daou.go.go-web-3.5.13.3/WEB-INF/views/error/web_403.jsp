...
<%
	...
	Object backHistorySize = request.getAttribute("backHistorySize");
	if (backHistorySize == null) {
	    backHistorySize = "-1";
	}

	Object errorMsgPropertyKey = request.getAttribute("errorMsgPropertyKey");
	if (errorMsgPropertyKey == null) {
	    errorMsgPropertyKey = "error.403.content";
	}
%>
		<!-- 오류페이지 -->
		<div class="view_content">
			<div class="error_page">
				<hgroup>
					...
					<h2><%= messageSourceHelper.getMessage("error.403.title") %></h2>
				</hgroup>
				<p class="desc"><%= messageSourceHelper.getMessage(String.valueOf(errorMsgPropertyKey)) %></p>
				<a class="btn_major_s" onclick="javascript:history.go(<%= backHistorySize %>);" style="cursor: pointer; display: none;">
