            ...
            <div class="content_page">
                <div class="content">
                    <div class="notice" style="margin-top:0">
                        ...
                        <h2 class="title"><%= messageSourceHelper.getMessage("error.400.title") %></h2>
                        <span class="desc"><%= messageSourceHelper.getMessage("error.400.content") %></span>
                        <br />
                        <a class="btn_major_s" onclick="javascript:GOMobile400ErrorPage.back400Error();" style="cursor: pointer;"><span class="btn_major" data-role="button"><span class="txt"><%= messageSourceHelper.getMessage("common.page.back") %></span></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var GOMobile400ErrorPage = {};

    GOMobile400ErrorPage.back400Error = function() {
        var ua = "${faviconPath}";
