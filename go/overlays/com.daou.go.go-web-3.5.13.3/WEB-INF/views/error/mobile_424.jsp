			...
			<div class="content_page">
				<div class="content">
					<div class="notice" style="margin-top:0">
						...
						<h2 class="title"><%= messageSourceHelper.getMessage("error.424.title") %></h2>
						<span class="desc"><%= messageSourceHelper.getMessage("error.424.content") %></span>
						<br />
						<a class="btn_major_s" onclick="javascript:goHome();" style="cursor: pointer;"><span class="btn_major" data-role="button"><span class="txt"><%= messageSourceHelper.getMessage("common.page.home") %></span></span></a>
					</div>
				</div>
			</div>			
		</div>
